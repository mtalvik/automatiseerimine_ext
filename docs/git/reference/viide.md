...
### Harude Loomine ja Vahetamine```bash
...
### Failide Lisamine ja Eemaldamine```bash
...
### Commit'ide Identifitseerimine```bash
...
##  Ajutine Salvestamine (Stash)```bash
...
##  Otsimine ja Filtreerimine```bash
