...
Täna õpid Ansible rolle - professionaalset viisi Ansible koodi organiseerimiseks ja jagamiseks.
...
- **Refleksioon:** "Ansible role on nagu... A) retsept  B) LEGO komplekt  C) moodul Pythonis "
