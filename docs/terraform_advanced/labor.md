# Terraform Edasijõudnud Labor

Täna õpid Terraform'i edasijõudnud funktsioone: workspaces, modules ja remote state.
...
- **Refleksioon:** "Esimene pilve ressurss loomise tunne: A) hirmutav  B) põnev  C) võimas "
