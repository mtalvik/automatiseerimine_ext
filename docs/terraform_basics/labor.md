...
Täna õpid Terraform'i - tööriista, mis võimaldab kirjeldada infrastruktuuri koodina.
...
- **Refleksioon:** "Terraform on nagu... A) ehitusplaan  B) robot  C) maagiline võlukepike "
...
##  Samm 1: Terraform'i installimine ja seadistamine
...
##  Samm 2: Lihtsa Terraform projekti loomine
...
##  Samm 3: Muudatuste tegemine ja haldamine
